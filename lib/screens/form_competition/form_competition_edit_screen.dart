...
class FormCompetitionEditScreen extends StatefulWidget {
  @override
  _FormCompetitionEditScreenState createState() => _FormCompetitionEditScreenState();
}

class _FormCompetitionEditScreenState extends State<FormCompetitionEditScreen> {
  ...
  void initState() {
    ...
    {
      final Competition competition = ModalRoute
          .of(context)!
          .settings
          .arguments as Competition;
      setState(() {
        ctrlTitle.text = competition.title;
        ctrlDesc.text = competition.description;
        ctrlTitle.text = competition.title;
      });
    });
  }
          ...
          PopupMenuButton(
            ...
            itemBuilder: (BuildContext context) => [
              PopupMenuItem(
                child: Text("Delete"),
                onTap: () async {
                  await _courseServices.competitionRepository.deleteById(competition.id);
            ...
            child: Column(children: [
              imageFile == null
                ...
                child: Padding(
                  ...
                  child: competition.imageUrl != "" ? Image.network(competition.imageUrl,fit: BoxFit.contain) : Image.asset('assets/images/placeholder-img.png',fit: BoxFit.contain,
                    width: 175,),
                ),
              )
                  : InkWell(
